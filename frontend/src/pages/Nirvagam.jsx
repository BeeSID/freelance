        ...
        <table className="min-w-full table-auto border border-gray-300">
          <thead className="bg-green-100">
            <tr>
              ...
              <th className="border px-2 py-1 md:px-4 md:py-2">பெயர்</th>
              <th className="border px-2 py-1 md:px-4 md:py-2">பதவி</th>
              <th className="border px-2 py-1 md:px-4 md:py-2">மாவட்டம்</th>
              <th className="border px-2 py-1 md:px-4 md:py-2">தொலைபேசி</th>
            </tr>
          </thead>
          <tbody>
            {nirvagamData.map((member) => (
